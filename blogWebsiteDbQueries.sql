...
-- Blog Content Table
 create table blogcontent(blogId int primary key auto_increment, blogAuthor int not null, blogTopic varchar(100) not null, blogTitle varchar(100) not null, blogContent text, blogMediaUrl text, createdOn TIMESTAMP default CURRENT_TIMESTAMP not null, likes int default 0, dislikes int default 0, privacy Boolean not null, status Boolean not null default true, foreign key(blogAuthor) references user(userID))ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
